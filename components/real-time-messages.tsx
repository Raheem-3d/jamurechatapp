  ...
  const refreshMessages = useCallback(async () => {
    ...
    setMessages(prev => {
      ...
      for (const m of fetched) {
        ...
        const mergedReactions = (Array.isArray((m as any).reactions) && (m as any).reactions.length > 0)
          ? (m as any).reactions
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto min-h-0">
        ...
        <MessageList messages={messages} currentUserId={currentUserId} onlineUsers={onlineUsers} users={users} />
