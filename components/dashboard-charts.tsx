...
export function PerformanceRadarChart({ performanceData }: { performanceData: PerformanceDataPoint[] }) {
  return (
    <Card className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs overflow-hidden">
      <CardHeader className="pb-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 p-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <CardTitle className="text-sm font-bold text-slate-900 dark:text-white">Performance Overview</CardTitle>
      ...
      <Card className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs overflow-hidden">
        <CardHeader className="pb-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 p-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <CardTitle className="text-sm font-bold text-slate-900 dark:text-white">Task Trends</CardTitle>
              <CardDescription className="text-[11px] text-slate-500 dark:text-slate-400">
      ...
      <Card className="rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs overflow-hidden">
        <CardHeader className="pb-3 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 p-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <CardTitle className="text-sm font-bold text-slate-900 dark:text-white">Task Status</CardTitle>
              <CardDescription className="text-[11px] text-slate-500 dark:text-slate-400">
