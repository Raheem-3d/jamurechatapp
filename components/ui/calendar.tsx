...
type RenderDayExtras = (date: Date) => React.ReactNode
...
function Calendar({
  ...
  formatters,
  components,
  renderDayExtras, // ⬅️ allows custom content under date
  ...props
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        DayButton: (p: any) => (
          <CalendarDayButton {...p} renderDayExtras={renderDayExtras} />
        ),
...
function CalendarDayButton({
  ...
  return (
    ...
    >
      {/* Date number */}
      <span className="text-xs opacity-70">{day.date.getDate()}</span>

      {/* Custom content below date (titles/descriptions) */}
